...
from fxhash_indexer.types.gentk_minter.parameter.update_issuer import UpdateIssuerParameter
from fxhash_indexer.types.gentk_minter.storage import GentkMinterStorage


async def on_update_issuer_v1(
    ctx: HandlerContext,
    update_issuer: Transaction[UpdateIssuerParameter, GentkMinterStorage],
) -> None:
