...
from fxhash_indexer.types.gentk_minter_v1.parameter.mint_issuer import MintIssuerParameter
...
async def on_mint_issuer_v1(
        ctx: HandlerContext,
        mint_issuer: Transaction[MintIssuerParameter, GentkMinterV1Storage],
    ) -> None:
